<section class="content">
	...
	<div class="card">
		...
		<br>
		<form class="form-horizontal" target="_blank" method="POST" role="form" id="formSearch" action="<?php echo base_url() ?>administrator/laporanpembayaran/laporanpembayaran">
			<div class="card card-info">
				<div class="modal-header">
