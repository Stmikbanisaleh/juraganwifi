...
class Model_generate_tagihan_logc extends CI_model
{
    ...
    {
		return $this->db->query("Select b.nopo, b.noqo, b.no_services,b.name,b.email,b.address from invoice_corporate a
    ...
    {
		return $this->db->query("Select b.id as item_id , b.price as price from service2 a
		join package_item b on a.id_service = b.id
		join customer_corporate c on c.no_services = a.id_customer
